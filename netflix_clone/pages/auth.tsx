...
const Auth = () => {
    ...
    return(
        <div className="relative h-full w-full bg-[url('/images/auth_background_img.jpeg')] bg-no-repeat bg-center bg-fixed bg-cover">
            <div className="bg-black w-full h-full lg:bg-opacity-50">
                <nav className="px-12 py-5">
                    <img src="/images/logo.png" alt="Logo" className="h-12"/>
                </nav>
                <div className="flex justify-center">
                    <div className="bg-black bg-opacity-90 px-16 py-16 self-center mt-2 lg:2/5 lg:max-w-md ronnded-md w-full">
                        ...
                        <p className="text-neutral-500 mt-12">
                            ...
                            <span onClick={toggleVariant} className="text-white ml-1 hover:underline cursor-pointer px-1">
                                {variant == 'login' ? 'Create an Account Today!' : 'Login to your account!'}
                            </span>
                        </p>
                    </div>
                </div>
